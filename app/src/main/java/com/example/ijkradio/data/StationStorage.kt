...
class StationStorage(private val context: Context) {
    ...
    companion object {
        ...
        private const val KEY_PLAYER_TYPE = "player_type"  // 播放器类型: "ijk" 或 "exo"
    }
    ...
    /**
     * 保存播放器类型
     * @param type 播放器类型: "ijk" 或 "exo"
     */
    fun savePlayerType(type: String) {
    ...
    fun getPlayerType(): String {
        return prefs.getString(KEY_PLAYER_TYPE, "ijk") ?: "ijk"
    }
